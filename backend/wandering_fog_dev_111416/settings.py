"""
Django settings for wandering_fog_dev_111416 project.
...
ROOT_URLCONF = 'wandering_fog_dev_111416.urls'
...
WSGI_APPLICATION = 'wandering_fog_dev_111416.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wandering_fog_dev_111416 API",
    "DESCRIPTION": "API documentation for wandering_fog_dev_111416 App",
    "VERSION": "v1",
}
